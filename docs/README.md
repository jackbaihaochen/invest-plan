...
当前设计与决策的存放处。`PROGRESS.md` 是工作日志（什么时候发生了什么），这里是
**现在是怎么设计的、为什么**。
...
| [sheet-setup.md](sheet-setup.md) | Google Sheet + Apps Script 的一次性配置步骤 |
...
`docs/specs/` 暂不建立 —— 单人项目，需求还在动，一份被批准的 proposal 就是当前的
规格。等到有了会被别人依赖的稳定接口再说。
